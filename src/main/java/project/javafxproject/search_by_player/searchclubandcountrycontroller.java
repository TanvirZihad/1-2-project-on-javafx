...
public class searchclubandcountrycontroller {
    private ObjectOutputStream oos;
    private ObjectInputStream ois;
    @FXML
    public TextField countrytosearch,clubtosearch;
    @FXML
    ...
    public void load() throws IOException, ClassNotFoundException {
        ...
        oos.writeObject("search_by_clubandcountry");
        ois.readObject();
        ...
        if(lis.isEmpty()){
            ...
            String b="No such player with this club ans country";
            main.showAlert(a,b);
        }
        else {
            for (Player p : lis) {
    ...
    public void search(ActionEvent event) throws IOException, ClassNotFoundException {
        country=countrytosearch.getText();
